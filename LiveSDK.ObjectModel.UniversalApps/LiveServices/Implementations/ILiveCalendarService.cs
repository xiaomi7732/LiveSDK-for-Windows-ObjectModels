...
namespace LiveSDK.ObjectModel.LiveServices.Interfaces
{
    ...
    public interface ILiveCalendarService
    {
        ...
        Task<string> CreateCalendar(string name, string description);
        ...
        /// <returns></returns>
        Task<Calendar> GetCalendar(string calendarId, System.Threading.CancellationToken? cancel);
        ...
        Task<Calendars> GetMyCalendars(System.Threading.CancellationToken? cancel);
        ...
        /// <returns></returns>
        Task Subscribe(string name, string description, string subscribeUrl);
        Task UpdateCanedlar(Calendar updateSpec);
    }
}
